...
public class KafkaController {
    ...
    @GetMapping("/notify-from-admin")
    public String notifyAdmin() throws Exception {
        // to enable messaging delay (sync operation), uncomment code below
        //latch = new CountDownLatch(messagesPerRequest);
        this.template.send(topicName, String.valueOf(1), "Pesan untuk admin");
        logger.info("Pesan dari admin diterima");
        return "Pesan admin";
    }
}
